$(document).ready(function() {
    ...
    const planets = [
        ...
        { name: "Jupiter", texture: 'imagen/jupiter.png', distance: 4.0, speed: 0.005 },   
        ...
        if (event.which === 1) { // Clic izquierdo
            ...
            if (intersects.length > 0) {
                ...
                if (followingPlanet.name === 'Tierra') {
                    infoContent.text('La Tierra es el tercer planeta desde el Sol y el único conocido con vida. Diámetro: 12,742 km.');
                } 
                else if (followingPlanet.name === 'Luna') {
                    infoContent.text('La Luna es el único satélite natural de la Tierra. Diámetro: 3,474 km. Distancia a la Tierra: 384,400 km.');
                } else if (followingPlanet.name === 'Mercurio') {
                    infoContent.text('Mercurio es el planeta más cercano al Sol. Diámetro: 4,880 km. Distancia a la Tierra: 77 millones de km.');
                } else if (followingPlanet.name === 'Venus') {
                    infoContent.text('Venus es el segundo planeta desde el Sol y es similar en tamaño a la Tierra. Diámetro: 12,104 km. Distancia a la Tierra: 41 millones de km.');
                } else if (followingPlanet.name === 'Marte') {
                    infoContent.text('Marte es conocido como el planeta rojo. Diámetro: 6,779 km. Distancia a la Tierra: 78 millones de km.');
                } else if (followingPlanet.name === 'Jupiter') {
                    infoContent.text('Jupiter es el planeta más grande del sistema solar. Diámetro: 142,984 km. Distancia a la Tierra: 628 millones de km.');
                } else if (followingPlanet.name === 'Saturno') {
                    infoContent.text('Saturno es conocido por sus anillos impresionantes. Diámetro: 120,536 km. Distancia a la Tierra: 1,275 millones de km.');
                } else if (followingPlanet.name === 'Urano') {
                    infoContent.text('Urano tiene un eje de rotación único que está casi paralelo a su órbita. Diámetro: 51,118 km. Distancia a la Tierra: 2,724 millones de km.');
                } else if (followingPlanet.name === 'Neptuno') {
                    infoContent.text('Neptuno es el planeta más distante del Sol. Diámetro: 49,528 km. Distancia a la Tierra: 4,351 millones de km.');
                } else {
    ...
    inputField.on('keypress', function(event) {
        if (event.which === 13) { // Presionar Enter
            ...
            const celestial = [earth, moon, ...planetMeshes.map(planet => planet.mesh)].find(planet => planet.name.toLowerCase() === inputText);
            if (celestial) {
